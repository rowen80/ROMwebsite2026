...
function buildReviewBlockHtml_() {
 return (
  "If you are happy with our service and would like to show your appreciation, or help us improve, " +
  "please leave a review at the link below. It really helps our business grow:<br><br>" +
...
function runPhotosOnly_(opts) {
 ...
 const linksText = (opts.includeReview ? buildReviewBlockText_() + "\n\n" : "") + buildMediaLinksText_(items, ctx.idx);
 const linksHtml = (opts.includeReview ? buildReviewBlockHtml_() + "<br><br>" : "") + buildMediaLinksHtml_(items, ctx.idx);
