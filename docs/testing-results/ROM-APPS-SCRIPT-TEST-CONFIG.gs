/***********************
 * ROM: Delivery + Invoicing - TEST CONFIGURATION
 * UPDATED 2026-03-26: Configured for Phase 1 Baseline Testing
 * Base version: ROM-APPS-SCRIPT-WITH-REELS.gs (2026-03-22)
 * 
 * TEST ENVIRONMENT CHANGES:
 * - Template: _TEST_ROM_INVOICE_TEMPLATE (test copy)
 * - Invoice folder: ROM_INVOICES_test (Bardo's Drive)
 * - BCC emails: bardo.faraday+tc@gmail.com (all test emails go to Bardo)
 * - Invoice numbers: 9999-XXXX sequence (SETTINGS!B1 = 9999-0001)
 * 
 * SAFETY: Work ONLY on staging sheet (ROMwebsite2026_data)
 * DO NOT deploy to ROM_CUSTOMER_MASTER in this configuration!
 ***********************/

const SHEET_NAME = ""; // "" = active sheet
const SETTINGS_SHEET_NAME = "SETTINGS";
const DOC_TEMPLATE_NAME = "_TEST_ROM_INVOICE_TEMPLATE";  // ⚠️ TEST VERSION
const INVOICE_FOLDER_NAME = "ROM_INVOICES_test";  // ⚠️ TEST FOLDER (Bardo's Drive)
...
const EMAIL_FROM_ADDRESS = "ryan@ryanowenphotography.com";  // Keep production FROM address
const EMAIL_BCC_ADDRESS = "bardo.faraday+tc@gmail.com";  // ⚠️ TEST: All emails BCC to Bardo
